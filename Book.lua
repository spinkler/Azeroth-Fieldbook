...
function ns.CreateBook(journal)
    ...
    local function build()
        ...
        paper:SetColorTexture(0.704, 0.624, 0.480, 1)
        ...
        page:SetVertexColor(0.80, 0.80, 0.776)
        ...
        effectPaper:SetColorTexture(0.672,0.568,0.376,1)
        ...
        formPaper:SetVertexColor(0.80,0.80,0.776)
        ...
        notesPaper:SetColorTexture(0.656,0.552,0.368,1)
        ...
        helpPaper:SetTexCoord(0,1,0,1); helpPaper:SetVertexColor(0.80,0.80,0.776)
