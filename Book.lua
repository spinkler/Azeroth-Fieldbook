...
function ns.CreateBook(journal)
    ...
    local function build()
        ...
        page:SetVertexColor(1.00, 1.00, 0.97)
        ...
        book.closeButton:SetPoint("RIGHT",-2,0); book.closeButton:SetSize(24,24); book.closeButton:SetScript("OnClick",function() book:Hide() end)
        ...
        book.title = label(book, "", 326, -55, 365, "GameFontNormalLarge")
        ...
        book.subTitle = label(book, "", 326, -84, 570)
        ...
        effectPaper:SetColorTexture(0.84,0.71,0.47,1)
        ...
        notesPaper:SetColorTexture(0.82,0.69,0.46,1)
